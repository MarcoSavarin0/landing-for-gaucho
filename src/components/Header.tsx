        ...
        <>
            ...
            <section className='mt-24 md:mt-36 md:relative md:w-[65%] lg:w-[70%]'>
                ...
                <Image
                    ...
                    width={100}
                    height={100}
                    className='hidden md:block md:absolute md:top-2 md:-right-12 lg:-right-2 xl:-right-24 2xl:right-24'
                />
                ...
                <div className='mt-7 relative md:mt-10'>
                    ...
                    <Image
                        ...
                        width={100}
                        height={100}
                        className='absolute -top-4 right-0 rotate-3 md:right-20 md:rotate-0 lg:right-[23%] lg:-top-12 lg:-rotate-6 lg:w-44 xl:right-[35%] 2xl:right-[55%]'
                    />
                </div>
            </section>
        </>
